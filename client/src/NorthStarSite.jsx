  ...
  const testimonials = [
    {
      ...
      review:
        "Excellent service from start to finish. My car arrived on time and in perfect condition. Communication was clear and honest.",
    },
    {
      name: "Sarah L.",
      service: "Enclosed Auto Transport",
      review:
        "I shipped my luxury vehicle enclosed and couldn’t be happier. Very professional and stress-free experience.",
    },
    {
      name: "David K.",
      service: "Motorcycle Shipping",
      review:
        "They handled my motorcycle with extreme care. Pickup and delivery were smooth and well coordinated.",
    },
    {
      name: "Jennifer M.",
      service: "Heavy Vehicle Transport",
      review:
        "Reliable, efficient, and transparent pricing. Everything went exactly as promised.",
    },
    {
      name: "Robert T.",
      service: "Open Trailer Transport",
      review:
        "Outstanding service and constant updates. My vehicle arrived safely and on schedule.",
    },
    {
      name: "Emma S.",
      service: "Enclosed Auto Transport",
      review:
        "Perfect experience from start to finish. I would absolutely use them again.",
    },
  ];
            ...
            >
              {testimonials
                ...
                .map((item, index) => (
                  ...
                  >
                    <div className="h-full bg-[#F2E9D8]/60 border border-[#1F3A5F]/10 rounded-2xl p-6 shadow-lg">
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="text-center mb-16">
      ...
      <h2 className="text-3xl md:text-4xl font-bold text-[#1F3A5F] mb-4">
        Trusted Nationwide for Auto Transport
      </h2>
