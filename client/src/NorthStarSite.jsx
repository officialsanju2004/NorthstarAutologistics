...
<section className="py-20 bg-white overflow-hidden">
  <div className="container mx-auto px-6">
      ...
      >
        {[
          ...
          },
          {
            ...
            service: "Open Trailer Transport",
            review:
              "Outstanding service! The team was professional and kept me informed at every step. My vehicle arrived safely and on schedule.",
          ...
          },
          {
            ...
            service: "Enclosed Auto Transport",
            review:
              "Perfect experience from start to finish. My classic car was treated with the utmost care. Will definitely use again!",
    ...
    {/* Navigation Dots */}
    <div id="slider-dots" className="flex justify-center gap-2 mt-8">
  ...
  <style>{`
    ...
    @media (min-width: 768px) {
      #testimonial-slider {
        width: 200%; /* 2 slides with 3 testimonials each */
      }
      #testimonial-slider > div {
        min-width: 33.333%;
      }
    ...
    __html: `
      (function() {
        ...
        function initSlider() {
          ...
          totalSlides = isMobile ? 6 : 2; // 6 slides on mobile, 2 on desktop
          ...
          for (let i = 0; i < totalSlides; i++) {
            ...
            dot.className = i === 0 ? 'slider-dot active' : 'slider-dot inactive';
